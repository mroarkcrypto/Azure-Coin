...
// Bloodstone: was 40000 (~67 P2PKH inputs; ~25k STONE of 100-STONE mining UTXOs fails with "Transaction too large").
// Allow near-block-weight standard txs so large consolidations/spends relay and wallet-build succeed.
static const unsigned int MAX_STANDARD_TX_WEIGHT = MAX_BLOCK_WEIGHT - 4000;
