...
BOOST_AUTO_TEST_CASE(GetFeeTest)
{
    ...
    /* Test for the special handling of overflows in SpaceXpanse.  */
...
BOOST_AUTO_TEST_CASE(ToStringTest)
{
    CFeeRate feeRate;
    feeRate = CFeeRate(1);
    BOOST_CHECK_EQUAL(feeRate.ToString(), "0.00000001 ROD/kvB");
    BOOST_CHECK_EQUAL(feeRate.ToString(FeeEstimateMode::BTC_KVB), "0.00000001 ROD/kvB");
