...
// 128 bit rotation (64-bit targets only)
#if defined(__SIZEOF_INT128__)
#define bswap_128( x ) \
    ( ( (unsigned __int128)(bswap_64( (uint64_t)(x & 0xffffffffffffffffULL) ) ) << 64 ) \
    | ( (unsigned __int128)(bswap_64( (uint64_t)((unsigned __int128)(x) >> 64) ) ) ) )
#endif
...
// Compiler provides __int128 only on 64-bit targets (x86_64, aarch64).
// 32-bit ARM (armeabi-v7a / armv7a) does not — do not force GCC_INT128 there.
#if defined(__SIZEOF_INT128__)
  #define GCC_INT128 1
#endif
