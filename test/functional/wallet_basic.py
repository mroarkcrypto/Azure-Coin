...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        for target, mode in product([-1, 0], ["rod/kb", "sat/b"]):
        ...
        if not self.options.descriptors:
            ...
            assert_raises_rpc_error(-5, "Bech32m addresses cannot be imported into legacy wallets", self.nodes[0].importaddress, "rodrt1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqam9emx")
        ...
        address_info = self.nodes[0].getaddressinfo("cXsfqGevYm5xx1EiunHsZ9uBVFF9CkCYQd")
        assert_equal(address_info['address'], "cXsfqGevYm5xx1EiunHsZ9uBVFF9CkCYQd")
